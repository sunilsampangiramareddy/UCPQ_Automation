...
public class TC_Create1POpportunity extends BaseClass{
	...
	public String current_URL; String testCase="TC_Create1POpportunity"; String booleanStatus="PASS";
	
	
	@Test(dataProvider="TC_Create1POpportunity", dataProviderClass=DataProviders.class, retryAnalyzer = RetryAnalyzer.class, groups={"Smoke", "Regression", "Master"})
	public void TC_Create1POpportunity (String userName, String accountName, String opportunityType, String opportunityName, String primaryContact, String salesPlay, String salesType, String installedBaseType, String currency, String channel, String hyperscaler, String pathway, String partnerSalesModel, String endCustomerUsage, String reseller, String resellerSalesRep, String resellerSE) throws InterruptedException, IOException
	{
		...
		logger.info("Started TC_Create1POpportunity Test Execution");
